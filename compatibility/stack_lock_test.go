...
const (
	wantReleaseID             = "idena-mainnet-legacy-compat-2026.09.24-rc14"
	wantNodeCommit            = "5c637643a0c47606a4605915a5a32ca9b01d4a2f"
	wantRuntimeCommit         = "5c637643a0c47606a4605915a5a32ca9b01d4a2f"
